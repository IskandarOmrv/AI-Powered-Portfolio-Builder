...
const SplitTemplate = ({ data, theme }) => {
    const styles = themeStyles[theme] || themeStyles.Light;
    const hasContactInfo = data.contact?.email || data.contact?.phone || data.contact?.linkedin;

    return (
        <div className="resume-template split-template" style={{ background: styles.background }}>
            {/* Header */}
            ...
            {/* Main Content */}
            <div className="resume-content split-content">
                {/* Left Column */}
