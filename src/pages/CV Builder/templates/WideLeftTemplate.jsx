...
const WideLeftTemplate = ({ data, theme }) => {
    const styles = themeStyles[theme] || themeStyles.Light;
    const hasContactInfo = data.contact?.email || data.contact?.phone || data.contact?.linkedin;

    return (
        <div className="resume-template wide-left-template" style={{ background: styles.background }}>
            {/* Header */}
            ...
            {/* Main Content */}
            <div className="resume-content wide-left-content">
                {/* Left Column (Wide) */}
...
export default WideLeftTemplate;